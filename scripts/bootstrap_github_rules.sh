...
#   bash scripts/bootstrap_github_rules.sh basic-blockchain basic-blockchain-frontend "ci / ci,enforce-merge-policy" "ci / ci" "enforce-merge-policy" "" "" "2" "1" "2" "1" "1"
#
# Optional env vars:
...
ORG="${1:?Missing org}"
REPO="${2:?Missing repo}"
MAIN_CHECKS="${3:-ci / ci,enforce-merge-policy}"
DEVELOP_CHECKS="${4:-ci / ci}"

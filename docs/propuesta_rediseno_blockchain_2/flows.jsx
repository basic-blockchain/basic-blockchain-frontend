...
function FlowRouter({ flow, onClose, onComplete }) {
  ...
  if (flow.type === 'wallet-detail' && window.WalletDetailDrawer) return <window.WalletDetailDrawer data={flow.data} onClose={onClose} onAction={(a,w) => { onComplete && onComplete({a,w}); }} />;
  if (flow.type === 'audit-event' && window.AuditEventFlow) return <window.AuditEventFlow data={flow.data} onClose={onClose} />;
  if (flow.type === 'send-detail' && window.SendDetailFlow) return <window.SendDetailFlow data={flow.data} onClose={onClose} />;
  if (flow.type === 'currency-form' && window.CurrencyFormFlow) return <window.CurrencyFormFlow data={flow.data} onClose={onClose} onComplete={onComplete} />;
  if (flow.type === 'peer-actions' && window.PeerActionsFlow) return <window.PeerActionsFlow data={flow.data} onClose={onClose} onComplete={onComplete} />;
  if (flow.type === 'validation-run' && window.ValidationRunFlow) return <window.ValidationRunFlow data={flow.data} onClose={onClose} onComplete={onComplete} />;
  if (flow.type === 'asset-detail' && window.AssetDetailFlow) return <window.AssetDetailFlow data={flow.data} onClose={onClose} />;
  if (flow.type === 'wallet-create' && window.WalletCreateFlow) return <window.WalletCreateFlow data={flow.data} onClose={onClose} onComplete={onComplete} />;
  if (flow.type === 'permissions' && window.PermissionsFlow) return <window.PermissionsFlow data={flow.data} onClose={onClose} onComplete={onComplete} />;
  if (flow.type === 'create-user' && window.CreateUserFlow) return <window.CreateUserFlow data={flow.data} onClose={onClose} onComplete={onComplete} />;
  if (flow.type === '2fa-setup' && window.TwoFASetupFlow) return <window.TwoFASetupFlow data={flow.data} onClose={onClose} onComplete={onComplete} />;
  return null;
}

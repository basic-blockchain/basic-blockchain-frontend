          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr', gap: 14, marginBottom: 14 }}>
            <div className="wallet-hero">
              ...
              <div className="acts">
                ...
                <button className="wh-btn" onClick={() => nav.openFlow('wallet-create', {})}>{I.plus}<span>Nueva wallet</span></button>
              </div>
            </div>
                  ...
                  <tbody>
                    {[
                      ...
                      <tr key={i} style={{ cursor: 'pointer' }}
                          onClick={() => nav.openFlow('asset-detail', { asset: { code: r[0], name: r[1], balance: r[2] + ' ' + r[0], value: r[3], delta: r[6], network: r[1] }})}>
                        <td>
            ...
            <div>
              ...
              <div className="card">
                ...
                <table className="tbl" style={{ fontSize: 12.5 }}>
                  <tbody>
                    {[
                      ['Recibido de Mateo F.', '+120.00 cUSD', 'mv-buy', I.arrowDown, 'hoy 09:24', 'Mateo Fernández'],
                      ['Envío a Sofía P.', '-85.50 cUSD', 'mv-sell', I.arrowUp, 'ayer 18:12', 'Sofía Pérez'],
                      ['Conversión USDT → cUSD', '+500.00 cUSD', 'mv-buy', I.arrowDown, 'ayer 14:01', 'USDT→cUSD'],
                      ['Emisión tesorería', '+500.00 cUSD', 'mv-dep', I.arrowDown, '10 may 09:01', 'admin@dropi.co'],
                      ['Envío a Lucía G.', '-40.00 cUSD', 'mv-sell', I.arrowUp, '08 may 17:20', 'Lucía González'],
                    ].map((r, i) => (
                      <tr key={i} style={{ cursor: 'pointer' }}
                          onClick={() => nav.openFlow('tx-detail', {
                            tx: { id: 'tx_w' + i, sender: r[1].startsWith('+') ? r[5] : 'jmartinez', receiver: r[1].startsWith('+') ? 'jmartinez' : r[5], amount: r[1].replace(/[+\-]/, '').split(' ')[0], currency: 'cUSD', fee: '0.0001', age: '—', size: 320 },
                            status: 'completed',
                            block: 11 - i,
                            confirmedAt: r[4],
                          })}>

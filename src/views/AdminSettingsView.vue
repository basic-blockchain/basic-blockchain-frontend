...
const operationToggles = ref([
  {
    key: 'registrations',
    label: 'Aceptar nuevos registros',
    value: true,
    desc: 'Cierra el formulario público de signup si se desactiva.',
  },
  {
    key: 'p2p',
    label: 'Operaciones P2P',
    value: true,
    desc: 'Permite ofertas y matches entre usuarios.',
  },
  {
    key: 'exchange',
    label: 'Exchange',
    value: true,
    desc: 'Habilita órdenes de mercado y límite.',
  },
  {
    key: 'onchain_wd',
    label: 'Retiros on-chain',
    value: true,
    desc: 'Si se desactiva, sólo movimientos internos.',
  },
  {
    key: 'maintenance',
    label: 'Modo mantenimiento',
    value: false,
    desc: 'Sólo administradores pueden operar.',
  },
])
...
function saveGeneral() {
  toast.add({
    severity: 'success',
    summary: 'Ajustes guardados',
    detail: 'La configuración general fue actualizada',
    life: 3000,
  })
}
...
.settings-nav-item.base-btn:hover {
  background: var(--hover);
  color: var(--text);
}
.settings-nav-item.base-btn.active {
